...
public final class CompilationUnit extends Node implements Mergeable<CompilationUnit> {
  ...
  public CompilationUnit(PackageDeclaration pakage, List<ImportDeclaration> imports,
      List<TypeDeclaration> types, List<Comment> comments) {
    this.pakage = pakage;
  ...
  public CompilationUnit(int beginLine, int beginColumn, int endLine, int endColumn,
      PackageDeclaration pakage, List<ImportDeclaration> imports, List<TypeDeclaration> types,
  ...
  public void merge(CompilationUnit remoteCU, MergeEngine configuration) {
    ...
    configuration
        .apply(getImports(), remoteCU.getImports(), resultImports, ImportDeclaration.class);
