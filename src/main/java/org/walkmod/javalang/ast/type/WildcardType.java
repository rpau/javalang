...
public final class WildcardType extends Type {
  ...
  public WildcardType(int beginLine, int beginColumn, int endLine, int endColumn,
      ReferenceType ext, ReferenceType sup) {
  ...
  public WildcardType(int beginLine, int beginColumn, int endLine, int endColumn,
      ReferenceType ext, ReferenceType sup, List<AnnotationExpr> annotations) {
