...
public final class NormalAnnotationExpr extends AnnotationExpr {
  ...
  public NormalAnnotationExpr(int beginLine, int beginColumn, int endLine, int endColumn,
      NameExpr name, List<MemberValuePair> pairs) {
  ...
  public void merge(AnnotationExpr t1, MergeEngine configuration) {
    ...
    configuration.apply(getPairs(), ((NormalAnnotationExpr) t1).getPairs(), pairsList,
