...
public final class ClassOrInterfaceDeclaration extends TypeDeclaration {
  ...
  public ClassOrInterfaceDeclaration(int beginLine, int beginColumn, int endLine, int endColumn,
      JavadocComment javaDoc, int modifiers, List<AnnotationExpr> annotations, boolean isInterface,
      String name, List<TypeParameter> typeParameters, List<ClassOrInterfaceType> extendsList,
      List<ClassOrInterfaceType> implementsList, List<BodyDeclaration> members) {
    super(beginLine, beginColumn, endLine, endColumn, annotations, javaDoc, modifiers, name,
        members);
    this.interface_ = isInterface;
    this.typeParameters = typeParameters;
    this.extendsList = extendsList;
  ...
  public void merge(TypeDeclaration remoteTypeDeclaration, MergeEngine configuration) {
    ...
    configuration.apply(getTypeParameters(),
        ((ClassOrInterfaceDeclaration) remoteTypeDeclaration).getTypeParameters(),
        typeParametersList, TypeParameter.class);
    ...
    configuration.apply(getImplements(),
        ((ClassOrInterfaceDeclaration) remoteTypeDeclaration).getImplements(), implementsList,
    ...
    configuration.apply(getExtends(),
        ((ClassOrInterfaceDeclaration) remoteTypeDeclaration).getExtends(), extendsList,
        ClassOrInterfaceType.class);
