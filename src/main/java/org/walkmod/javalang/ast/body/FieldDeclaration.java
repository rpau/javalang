...
public final class FieldDeclaration extends BodyDeclaration implements Mergeable<FieldDeclaration> {
  ...
  public FieldDeclaration(JavadocComment javaDoc, int modifiers, List<AnnotationExpr> annotations,
  ...
  public FieldDeclaration(int beginLine, int beginColumn, int endLine, int endColumn,
      JavadocComment javaDoc, int modifiers, List<AnnotationExpr> annotations, Type type,
  ...
  public void merge(FieldDeclaration remote, MergeEngine configuration) {
    ...
    configuration
        .apply(getVariables(), remote.getVariables(), resultList, VariableDeclarator.class);
