...
public abstract class BodyDeclaration extends Node {
  ...
  public BodyDeclaration(int beginLine, int beginColumn, int endLine, int endColumn,
      List<AnnotationExpr> annotations, JavadocComment javaDoc) {
  ...
  public void merge(BodyDeclaration remoteBodyDeclaration, MergeEngine configuration) {
    ...
    configuration.apply(getAnnotations(), remoteBodyDeclaration.getAnnotations(),
        resultAnnotations, AnnotationExpr.class);
