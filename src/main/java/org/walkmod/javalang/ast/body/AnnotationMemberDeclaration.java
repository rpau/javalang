...
public final class AnnotationMemberDeclaration extends BodyDeclaration implements
    Mergeable<AnnotationMemberDeclaration> {
  ...
  public AnnotationMemberDeclaration(JavadocComment javaDoc, int modifiers,
      List<AnnotationExpr> annotations, Type type, String name, Expression defaultValue) {
  ...
  public void merge(AnnotationMemberDeclaration remote, MergeEngine configuration) {
    ...
    setDefaultValue((Expression) configuration.apply(getDefaultValue(), remote.getDefaultValue(),
        Expression.class));
  }
}
