...
public final class EnumConstantDeclaration extends BodyDeclaration implements
  ...
  public EnumConstantDeclaration(JavadocComment javaDoc, List<AnnotationExpr> annotations,
      String name, List<Expression> args, List<BodyDeclaration> classBody) {
  ...
  public EnumConstantDeclaration(int beginLine, int beginColumn, int endLine, int endColumn,
      JavadocComment javaDoc, List<AnnotationExpr> annotations, String name, List<Expression> args,
  ...
  public void merge(EnumConstantDeclaration remote, MergeEngine configuration) {
    ...
    configuration.apply(getClassBody(), remote.getClassBody(), resultClassBody,
