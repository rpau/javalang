...
public final class MethodDeclaration extends BodyDeclaration implements
  ...
  public MethodDeclaration(JavadocComment javaDoc, int modifiers, List<AnnotationExpr> annotations,
      ...
      int arrayCount, List<ClassOrInterfaceType> throws_, BlockStmt block) {
  ...
  public MethodDeclaration(JavadocComment javaDoc, int modifiers, List<AnnotationExpr> annotations,
      List<TypeParameter> typeParameters, Type type, String name, List<Parameter> parameters,
      int arrayCount, List<ClassOrInterfaceType> throws_, BlockStmt block, boolean isDefault) {
    this(javaDoc, modifiers, annotations, typeParameters, type, name, parameters, arrayCount,
        throws_, block);
    this.isDefault = isDefault;
  }

  public MethodDeclaration(int beginLine, int beginColumn, int endLine, int endColumn,
  ...
  public MethodDeclaration(int beginLine, int beginColumn, int endLine, int endColumn,
      ...
      List<TypeParameter> typeParameters, Type type, String name, List<Parameter> parameters,
      int arrayCount, List<ClassOrInterfaceType> throws_, BlockStmt block, boolean isDefault) {
    this(beginLine, beginColumn, endLine, endColumn, javaDoc, modifiers, annotations,
        typeParameters, type, name, parameters, arrayCount, throws_, block);
    this.isDefault = isDefault;
  }
  ...
  public void merge(MethodDeclaration remote, MergeEngine configuration) {
    ...
    configuration.apply(getTypeParameters(), remote.getTypeParameters(), resultTypeParams,
        TypeParameter.class);
