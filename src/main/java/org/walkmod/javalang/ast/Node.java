...
public abstract class Node implements Serializable {
    ...
    public boolean contains(Node node2) {
        if ((getBeginLine() < node2.getBeginLine()) || ((getBeginLine() == node2.getBeginLine()) && getBeginColumn() <= node2.getBeginColumn())) {
    ...
    public boolean isInEqualLocation(Node node2) {
        if (!isNewNode() && !node2.isNewNode()) {
            return getBeginLine() == node2.getBeginLine() && getBeginColumn() == node2.getBeginColumn() && getEndLine() == node2.getEndLine() && getEndColumn() == node2.getEndColumn();
        }
        return false;
    }
