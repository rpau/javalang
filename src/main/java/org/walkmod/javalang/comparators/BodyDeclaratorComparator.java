...
public class BodyDeclaratorComparator implements Comparator<BodyDeclaration> {
    ...
    public BodyDeclaratorComparator() {
        order = new String[] {"FieldDeclaration", "EnumConstantDeclaration", "InitializerDeclaration",
                "ConstructorDeclaration", "AnnotationMemberDeclaration", "MethodDeclaration", "TypeDeclaration",
