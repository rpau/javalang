 ...
 * parser and Abstract Syntax Tree. If not, see <http://www.gnu.org/licenses/>.
 */
...
final class ASTParser implements ASTParserConstants {
    ...
    private Expression generateLambda(Expression ret, Statement lambdaBody) {
        ...
        if (ret instanceof EnclosedExpr) {
            ...
            if (inner != null && inner instanceof NameExpr) {
                id = new VariableDeclaratorId(inner.getBeginLine(), inner.getBeginColumn(), inner.getEndLine(),
                        inner.getEndColumn(), ((NameExpr) inner).getName(), 0);
                params = add(params, new Parameter(ret.getBeginLine(), ret.getBeginColumn(), ret.getEndLine(),
                        ret.getEndColumn(), 0, null, null, false, id));
                ret = new LambdaExpr(ret.getBeginLine(), ret.getBeginColumn(), lambdaBody.getEndLine(),
                        lambdaBody.getEndColumn(), params, lambdaBody, true);
            } else {
                ret = new LambdaExpr(ret.getBeginLine(), ret.getBeginColumn(), lambdaBody.getEndLine(),
                        lambdaBody.getEndColumn(), null, lambdaBody, true);
            }
        } else if (ret instanceof NameExpr) {
            id = new VariableDeclaratorId(ret.getBeginLine(), ret.getBeginColumn(), ret.getEndLine(),
                    ret.getEndColumn(), ((NameExpr) ret).getName(), 0);
            params = add(params, new Parameter(ret.getBeginLine(), ret.getBeginColumn(), ret.getEndLine(),
                    ret.getEndColumn(), 0, null, null, false, id));
            ret = new LambdaExpr(ret.getBeginLine(), ret.getBeginColumn(), ret.getEndLine(), ret.getEndColumn(), params,
                    lambdaBody, false);
    ...
    */
    final public CompilationUnit CompilationUnit() throws ParseException {
        ...
        {
            if (true)
                return new CompilationUnit(line == -1 ? 0 : line, column, token.endLine, token.endColumn, pakage,
                        imports, types, getComments());
        }
    ...
    */
    ...
    final public ClassOrInterfaceDeclaration ClassOrInterfaceDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true)
                return new ClassOrInterfaceDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(),
                        modifier.modifiers, modifier.annotations, isInterface, name, typePar, extList, impList,
                        members);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public EnumDeclaration EnumDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true)
                return new EnumDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(),
                        modifier.modifiers, modifier.annotations, name, impList, entries, members);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public EnumConstantDeclaration EnumConstantDeclaration() throws ParseException {
        ...
        {
            if (true)
                return new EnumConstantDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(),
                        annotations, name, args, classBody);
        }
        throw new Error("Missing return statement in function");
    }
                                ...
                                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                                    ...
                                    case LT:
                                        ...
                                        ((MethodDeclaration) ret)
                                                .setModifiers(addModifier(modifier.modifiers, aux, token));
                                        break;
                                    default:
                                        jj_la1[35] = jj_gen;
                                        jj_consume_token(-1);
    ...
    final public FieldDeclaration FieldDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true)
                return new FieldDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(),
                        modifier.modifiers, modifier.annotations, type, variables);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public MethodDeclaration MethodDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true)
                return new MethodDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(),
                        modifier.modifiers, modifier.annotations, typeParameters, type, name, parameters, arrayCount,
                        throws_, block);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public List InferredLambdaParameters() throws ParseException {
        ...
        jj_consume_token(COMMA);
        id = VariableDeclaratorId();
        ret = add(ret, new Parameter(id.getBeginLine(), id.getBeginColumn(), id.getEndLine(), id.getEndColumn(), 0,
                null, null, false, id));
        label_25: while (true) {
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                case COMMA:;
    ...
    final public Parameter FormalParameter() throws ParseException {
        ...
        {
            if (true)
                return new Parameter(line, column, token.endLine, token.endColumn, modifier.modifiers,
    ...
    final public ExplicitConstructorInvocationStmt ExplicitConstructorInvocation() throws ParseException {
        ...
        {
            if (true)
                return new ExplicitConstructorInvocationStmt(line, column, token.endLine, token.endColumn, typeArgs,
                        isThis, expr, args);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    */
    ...
    final public NameExpr Name() throws ParseException {
        ...
        label_37: while (true) {
            ...
            jj_consume_token(DOT);
            jj_consume_token(IDENTIFIER);
            ret = new QualifiedNameExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret,
                    token.image);
        }
        {
            if (true)
    ...
    */
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case DOUBLECOLON:
                if (jj_2_18(2)) {
                    ...
                    value = Expression();
                    ret = new AssignExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret,
                            value, op);
                } else {
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        case ARROW:
                        ...
                        case DOUBLECOLON:
                            ...
                            ret = new MethodReferenceExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine,
    ...
    final public Expression ConditionalExpression() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case HOOK:
                ...
                ret = new ConditionalExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret,
                        left, right);
                break;
            default:
                jj_la1[82] = jj_gen;;
    ...
    final public Expression ConditionalOrExpression() throws ParseException {
        ...
        label_41: while (true) {
            ...
            ret = new BinaryExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret, right,
    ...
    final public Expression InstanceOfExpression() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case INSTANCEOF:
                ...
                type = Type();
                ret = new InstanceOfExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn, ret,
                        type);
                break;
            default:
                jj_la1[90] = jj_gen;;
        ...
        if (jj_2_24(2)) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                ...
                case IDENTIFIER:
                    ...
                    ret = UnaryExpressionNotPlusMinus();
                    if (st != null) {
                        type = new IntersectionType(type.getBeginLine(), type.getBeginColumn(), token.endLine,
                                token.endColumn, secondaryTypes);
                    }
                    type.setAnnotations(annotations);
                    ret = new CastExpr(line, column, token.endLine, token.endColumn, type, ret);
                    break;
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case SUPER:
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case DOT:
                        ...
                        ret = hasArgs
                                ? new MethodCallExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine,
                                        token.endColumn, ret, typeArgs, name, args)
                                : new FieldAccessExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine,
                                        token.endColumn, ret, null, name);
                        break;
                    case DOUBLECOLON:
                        jj_consume_token(DOUBLECOLON);
                        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    ...
                    case LPAREN:
                        args = Arguments();
                        new MethodCallExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine, token.endColumn,
                                ret, typeArgs, null, args);
                        break;
                    default:
                        jj_la1[111] = jj_gen;
                        jj_consume_token(-1);
                ...
                if (!isLambda) {
                    ...
                    if (ret != null) {
                        if (ret instanceof NameExpr) {
                            id = new VariableDeclaratorId(ret.getBeginLine(), ret.getBeginColumn(), ret.getEndLine(),
                                    ret.getEndColumn(), ((NameExpr) ret).getName(), 0);
                            p = new Parameter(ret.getBeginLine(), ret.getBeginColumn(), ret.getEndLine(),
                                    ret.getEndColumn(), 0, null, null, false, id);
                        }

                    }
                    args = add(0, args, p);
                    ret = new LambdaExpr(p.getBeginLine(), p.getBeginColumn(), token.endLine, token.endColumn, args,
                            null, true);
                }
                break;
            case NEW:
            ...
            default:
                ...
                if (jj_2_28(2147483647)) {
                    ...
                    jj_consume_token(DOT);
                    jj_consume_token(CLASS);
                    ret = new ClassExpr(type.getBeginLine(), type.getBeginColumn(), token.endLine, token.endColumn,
                            type);
                    ...
                    ret = new TypeExpr(type.getBeginLine(), type.getBeginColumn(), type.getEndLine(),
                            type.getEndColumn(), type);
                    ret = new MethodReferenceExpr(ret.getBeginLine(), ret.getBeginColumn(), token.endLine,
                            token.endColumn, ret, typeArgs, token.image);
                } else {
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        case IDENTIFIER:
                            ...
                            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                                case LPAREN:
                                    args = Arguments();
                                    ret = new MethodCallExpr(line, column, token.endLine, token.endColumn, null, null,
                                            name, args);
                                    break;
                                default:
                                    jj_la1[118] = jj_gen;;
        ...
        if (jj_2_30(2)) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                case DOT:
                    jj_consume_token(DOT);
                    jj_consume_token(SUPER);
                    ret = new SuperExpr(scope.getBeginLine(), scope.getBeginColumn(), token.endLine, token.endColumn,
                            scope);
                    break;
                default:
                    jj_la1[121] = jj_gen;
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case DOT:
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case THIS:
                        jj_consume_token(THIS);
                        ret = new ThisExpr(scope.getBeginLine(), scope.getBeginColumn(), token.endLine, token.endColumn,
                                scope);
                        break;
                    case NEW:
                    ...
                    default:
                        ...
                        if (jj_2_31(2147483647)) {
                            ...
                            ret = hasArgs
                                    ? new MethodCallExpr(scope.getBeginLine(), scope.getBeginColumn(), token.endLine,
                                            token.endColumn, scope, typeArgs, name, args)
                                    : new FieldAccessExpr(scope.getBeginLine(), scope.getBeginColumn(), token.endLine,
            ...
            case LBRACKET:
                ...
                ret = Expression();
                jj_consume_token(RBRACKET);
                ret = new ArrayAccessExpr(scope.getBeginLine(), scope.getBeginColumn(), token.endLine, token.endColumn,
                        scope, ret);
                break;
            default:
                jj_la1[125] = jj_gen;
    ...
    final public Expression Literal() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case INTEGER_LITERAL:
                ...
                ret = new IntegerLiteralExpr(token.beginLine, token.beginColumn, token.endLine, token.endColumn,
                        token.image);
                break;
            case LONG_LITERAL:
                jj_consume_token(LONG_LITERAL);
                ret = new LongLiteralExpr(token.beginLine, token.beginColumn, token.endLine, token.endColumn,
                        token.image);
                break;
            case FLOATING_POINT_LITERAL:
                jj_consume_token(FLOATING_POINT_LITERAL);
                ret = new DoubleLiteralExpr(token.beginLine, token.beginColumn, token.endLine, token.endColumn,
                        token.image);
                break;
            case CHARACTER_LITERAL:
                jj_consume_token(CHARACTER_LITERAL);
                ret = new CharLiteralExpr(token.beginLine, token.beginColumn, token.endLine, token.endColumn,
                        token.image.substring(1, token.image.length() - 1));
                break;
            case STRING_LITERAL:
                jj_consume_token(STRING_LITERAL);
                ret = new StringLiteralExpr(token.beginLine, token.beginColumn, token.endLine, token.endColumn,
                        token.image.substring(1, token.image.length() - 1));
                break;
            case FALSE:
            case TRUE:
            ...
            case 132:
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    ...
                    case LPAREN:
                        ...
                        type.setAnnotations(annotations);
                        ret = new ObjectCreationExpr(line, column, token.endLine, token.endColumn, scope,
                                (ClassOrInterfaceType) type, typeArgs, args, anonymousBody);
                        break;
                    default:
                        jj_la1[133] = jj_gen;
                        jj_consume_token(-1);
    ...
    */
    final public Statement BlockStatement() throws ParseException {
        ...
        if (jj_2_37(2147483647)) {
            ...
            ret = new TypeDeclarationStmt(typeDecl.getBeginLine(), typeDecl.getBeginColumn(), token.endLine,
                    token.endColumn, typeDecl);
    ...
    final public VariableDeclarationExpr VariableDeclarationExpression() throws ParseException {
        ...
        {
            if (true)
                return new VariableDeclarationExpr(line, column, token.endLine, token.endColumn, modifier.modifiers,
    ...
    final public Statement LambdaBody() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case MINUS:
                expr = Expression();
                n = new ExpressionStmt(expr.getBeginLine(), expr.getBeginColumn(), token.endLine, token.endColumn,
                        expr);
                break;
            case LBRACE:
                n = Block();
    ...
    final public ExpressionStmt StatementExpression() throws ParseException {
                    ...
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        ...
                        case DOUBLECOLON:
                            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                                case INCR:
                                    jj_consume_token(INCR);
                                    expr = new UnaryExpr(expr.getBeginLine(), expr.getBeginColumn(), token.endLine,
                                            token.endColumn, expr, UnaryExpr.Operator.posIncrement);
                                    break;
                                case DECR:
                                    jj_consume_token(DECR);
                                    expr = new UnaryExpr(expr.getBeginLine(), expr.getBeginColumn(), token.endLine,
                                            token.endColumn, expr, UnaryExpr.Operator.posDecrement);
                                    break;
                                case ASSIGN:
                                case PLUSASSIGN:
                                case MINUSASSIGN:
                                ...
                                case RUNSIGNEDSHIFTASSIGN:
                                    op = AssignmentOperator();
                                    value = Expression();
                                    expr = new AssignExpr(expr.getBeginLine(), expr.getBeginColumn(), token.endLine,
                                ...
                                case DOUBLECOLON:
                                    ...
                                    expr = new MethodReferenceExpr(expr.getBeginLine(), expr.getBeginColumn(),
                                            token.endLine, token.endColumn, expr, typeArgs, token.image);
                                    break;
                                case ARROW:
                                    jj_consume_token(ARROW);
                                    lambdaBody = LambdaBody();
        ...
        {
            if (true)
                return new ExpressionStmt(expr.getBeginLine(), expr.getBeginColumn(), token.endLine, token.endColumn,
                        expr);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    */
    ...
    final public AnnotationDeclaration AnnotationTypeDeclaration(Modifier modifier) throws ParseException {
        ...
        {
            if (true)
                return new AnnotationDeclaration(line, column, token.endLine, token.endColumn, popJavadoc(),
                        modifier.modifiers, modifier.annotations, name, members);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] {0x0, 0x48101000, 0x1, 0x0, 0x0, 0x0, 0x40001000, 0x8100000, 0x48101000, 0x100000, 0x0,
                0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4a995000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x10000000, 0x0, 0x0, 0x0, 0x4a995000, 0x800000, 0x8100000, 0x2094000, 0x4a995000, 0x0, 0x0, 0x0,
                0x22094000, 0x22094000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x42095000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x22094000, 0x6359f000, 0x0, 0x2094000, 0x0, 0x0, 0x2094000, 0x0, 0x0, 0x0, 0x0, 0x2094000, 0x0, 0x0,
                0x10000000, 0x10000000, 0x2094000, 0x2094000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x22094000, 0x0, 0x0, 0x22094000,
                0x0, 0x0, 0x0, 0x2094000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x22094000, 0x62095000, 0x0, 0x0, 0x0,
                0x20000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20000000, 0x20000000, 0x22094000, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x2094000, 0x0, 0x0, 0x0, 0x0, 0x2349e000, 0x0, 0x2349e000, 0x0, 0x22094000, 0x0, 0x0, 0x0, 0x0,
                0x22094000, 0x820000, 0x820000, 0x4000000, 0x62095000, 0x22094000, 0x22094000, 0x62095000, 0x22094000,
                0x0, 0x0, 0x0, 0x22094000, 0x0, 0x40000, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x22094000, 0x22094000, 0x0,
                0x4a195000, 0xa194000, 0x4a195000, 0x800000,};
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] {0x20, 0x8899c500, 0x0, 0x0, 0x80000, 0x0, 0x8899c400, 0x100, 0x8899c500, 0x100, 0x0, 0x0,
                0x10, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0xc89dc781, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0xc89dc781, 0x0, 0x100, 0x40040281, 0xc89dc781, 0x0, 0x0, 0x0, 0x51241a81, 0x51241a81, 0x0, 0x0,
                0x0, 0x4000000, 0x0, 0x0, 0x889dc681, 0x0, 0x0, 0x0, 0x0, 0x4000000, 0x0, 0x0, 0x51241a81, 0xfbffdf8b,
                0x80000, 0x40281, 0x0, 0x0, 0x40281, 0x0, 0x0, 0x0, 0x0, 0x40281, 0x0, 0x0, 0x200000, 0x200000, 0x40281,
                0x40040281, 0x0, 0x0, 0x0, 0x0, 0x800, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x51241a81, 0x0, 0x0, 0x51241a81, 0x0, 0x0, 0x0, 0x40281, 0x0, 0x0,
                0x0, 0x800, 0x0, 0x0, 0x0, 0x51241a81, 0xd9bdde81, 0x0, 0x800, 0x0, 0x11201800, 0x0, 0x0, 0x0, 0x0,
                0x1000800, 0x0, 0x10001000, 0x10000000, 0x51241a81, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40281, 0x0, 0x0, 0x0,
                0x0, 0x73e61a8b, 0x0, 0x73e61a8b, 0x0, 0x51241a81, 0x0, 0x800, 0x0, 0x0, 0x51241a81, 0x0, 0x0, 0x0,
                0xd9bdde81, 0x51241a81, 0x51241a81, 0xd9bdde81, 0x51241a81, 0x0, 0x0, 0x0, 0x51241a81, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x51241a81, 0x51241a81, 0x0, 0x889dc781, 0x40381, 0x889dc781, 0x0,};
    }

    private static void jj_la1_init_2() {
        jj_la1_2 = new int[] {0x0, 0x4800000, 0x0, 0x4000000, 0x0, 0x2000000, 0x4000000, 0x4000000, 0x4800000, 0x0,
                0x10000000, 0x0, 0x0, 0x4000000, 0x1000000, 0x4000000, 0x1000000, 0x0, 0x4004000, 0x1000000, 0x14884000,
                0x800000, 0x4000000, 0x20000, 0x80000, 0x4000000, 0x1000000, 0x4000000, 0x0, 0x4000000, 0x0, 0x4000000,
                0x14884000, 0x0, 0x4000000, 0x10004000, 0x14804000, 0x1000000, 0x8000000, 0x200000, 0x600a7086,
                0x600a7086, 0x1000000, 0x10000000, 0x200000, 0x0, 0x880000, 0x1000000, 0x4004000, 0x1000000, 0x1000000,
                0x0, 0x10000000, 0x0, 0x10000000, 0x10000000, 0x10027086, 0x48a7087, 0x0, 0x0, 0x4000000, 0x4000000,
                0x4000, 0x4000000, 0x1000000, 0x10000000, 0x4000000, 0x80004000, 0x4000000, 0x4000000, 0x0, 0x0, 0x0,
                0x4000, 0x4000000, 0x1000000, 0x4000000, 0x10000000, 0x4000, 0x0, 0x8000000, 0x8000000, 0x80000000, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x60027086,
                0x60000000, 0x60000000, 0x27086, 0x0, 0x4000000, 0x0, 0x4000, 0x10000000, 0x20000, 0x10000000, 0x4000,
                0x2020000, 0x1000000, 0x1000000, 0x60027086, 0x64027086, 0x10000000, 0x4000, 0x20000, 0x23086, 0x4000,
                0x2000000, 0x10000000, 0x20000, 0x0, 0x2200000, 0x3086, 0x0, 0x60027086, 0x1000000, 0x4000000,
                0x4000000, 0x10000000, 0x4220000, 0x10004000, 0x4000000, 0x4000000, 0x200000, 0x200000, 0x8a7087, 0x0,
                0x8a7087, 0x1000000, 0x600a7086, 0x10000000, 0x4000, 0x8000000, 0x8000000, 0x27086, 0x0, 0x0, 0x0,
                0x64027086, 0x60027086, 0x60027086, 0x64827086, 0x60027086, 0x1000000, 0x4000, 0x4000, 0x60027086,
                0x20000, 0x0, 0x0, 0x0, 0x4000000, 0x4000, 0x1000000, 0x640a7086, 0x640a7086, 0x1000000, 0x4804000,
                0x4004000, 0x4804000, 0x0,};
    }

    private static void jj_la1_init_3() {
        jj_la1_3 = new int[] {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x780, 0x780, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20000000, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x180, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0xc0000000, 0xdffc0000, 0x1ffc0000, 0x0, 0x20, 0x40, 0x4000, 0x8000, 0x2000, 0x12, 0x12,
                0x0, 0xc, 0xc, 0x20000, 0x600, 0x600, 0x11800, 0x11800, 0x600, 0x780, 0x0, 0x0, 0x0, 0x180, 0x0, 0x2000,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x780, 0x780, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x780, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x180, 0x1, 0x180, 0x0,
                0x780, 0x0, 0x0, 0xdffc0180, 0xdffc0180, 0x100, 0x0, 0x0, 0x0, 0x780, 0x780, 0x780, 0x780, 0x780, 0x0,
                0x0, 0x0, 0x780, 0x0, 0x0, 0x4000, 0x0, 0x0, 0x0, 0x0, 0x780, 0x780, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }

    private static void jj_la1_init_4() {
        jj_la1_4 = new int[] {0x0, 0x0, 0x8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x10, 0x10, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
